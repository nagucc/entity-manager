(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('babel-runtime/core-js/json/stringify'), require('babel-runtime/regenerator'), require('babel-runtime/helpers/asyncToGenerator'), require('babel-runtime/core-js/promise'), require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/createClass'), require('mongo-use-collection'), require('mongodb'), require('debug')) :
  typeof define === 'function' && define.amd ? define(['exports', 'babel-runtime/core-js/json/stringify', 'babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', 'babel-runtime/core-js/promise', 'babel-runtime/helpers/classCallCheck', 'babel-runtime/helpers/createClass', 'mongo-use-collection', 'mongodb', 'debug'], factory) :
  (factory((global.entity-manager = global.entity-manager || {}),global._JSON$stringify,global._regeneratorRuntime,global._asyncToGenerator,global._Promise,global._classCallCheck,global._createClass,global.mongoUseCollection,global.mongodb,global.debug));
}(this, function (exports,_JSON$stringify,_regeneratorRuntime,_asyncToGenerator,_Promise,_classCallCheck,_createClass,mongoUseCollection,mongodb,debug) { 'use strict';
