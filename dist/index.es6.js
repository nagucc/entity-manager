...
import { GridStore, MongoClient } from 'mongodb';
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                ...
                gs = new GridStore(db, fileId, filename, 'w', options);
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 3:
                db = _context12.sent;
                _context12.next = 6;
                return GridStore.unlink(db, fileId);
...
export { EntityManager$1 as EntityManagerMongoDB };export default EntityManager;
